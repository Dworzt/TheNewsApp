...
public class SearchFragmentDirections private constructor() {
  private data class ActionSearchFragment2ToArticleFragment(
    public val article: Article,
  ) : NavDirections {
    public override val actionId: Int = R.id.action_searchFragment2_to_articleFragment
  ...
  public companion object {
    public fun actionSearchFragment2ToArticleFragment(article: Article): NavDirections =
        ActionSearchFragment2ToArticleFragment(article)
  }
}
